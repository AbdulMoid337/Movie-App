...
const Contact = () => {
  document.title = "Contact Us | Movie App";
  ...
  const contactInfo = [
    { icon: EnvelopeIcon, info: 'Abdulmoid337@gmail.com', label: 'Email' },
    { icon: PhoneIcon, info: '+91 9059576130', label: 'Phone' },
    { icon: MapPinIcon, info: 'Hyderabad, India', label: 'Address' },
  ];
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-16">
          ...
          >
            ...
            <form  action='https://formspree.io/f/xzzbprwk' method="POST"
              ...
              <button
                type="submit"
                className="bg-yellow-400 text-gray-900 px-6 py-2 rounded-md font-semibold hover:bg-yellow-300 transition duration-300"
              >
                Send Message
              </button>
            </form>
            ...
            <div className="space-y-6">
              {contactInfo.map((item, index) => (
                <div key={index} className="flex items-start">
                  <item.icon className="h-6 w-6 text-yellow-400 mr-3 mt-1" />
                  <div>
